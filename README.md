...
- **Диаграмма процесса**: [`task2_marketplace/publish_product_flow.svg`](task2_marketplace/publish_product_flow.svg)
...
- **Алгоритм валидации и создания**: [`task3_registration_api/user_creation_algorithm.md`](task3_registration_api/user_creation_algorithm.md)
